...
A small, accessible, and responsive Profile Card component built with semantic HTML, modern CSS, and vanilla JavaScript. This project was developed following web accessibility (A11y) standards and includes specific data-testid attributes for automated testing.
